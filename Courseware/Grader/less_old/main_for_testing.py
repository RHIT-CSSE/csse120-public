...
def main():
    ...
    """
    test_Grader()
#     tester.StandardTester = tester.UnittestTester
#
#     grader = make_Grader()
#     grader.checkout()
#
#     results = grader.tester.do_tests_on_students()
#     print(results)
...
def test_Grader():
    ...
    csse120 = course.CSSE120
    what_to_grade = grader.ThingToGrade(csse120, 4)

    grader_for_testing = grader.Grader(what_to_grade, ['mutchler'])
    grader_for_testing.grade()  # Use True as arg to checkout

# The following is just for experimenting with INSPECT.
