...
"""
A Grader grades the WhoToGrade in a WhatToGrade, using a:
  -- HowToGrade
  -- Recorder
...
from repoHelper import StandardRepoHelper
from howToGrade import StandardHowToGrade
from whoToGrade import StandardWhoToGrade
...
class Grader(object):
    ...
    :type this_who_to_grade: WhoToGrade
    :type this_how_to_grade: HowToGrade
    :type this_recorder:     Recorder
    :type this_repo_helper:  RepoHelper
    """

    def __init__(self,
                 what_to_grade,
                 this_who_to_grade=None,
                 this_how_to_grade=None,
                 this_recorder=None,
